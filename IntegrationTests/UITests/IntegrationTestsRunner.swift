...
class IntegrationTestsRunner: XCTestCase {
    ...
    func testNetworkIntegration() throws {
        ...
        XCTAssertEqual(networkSpan.stringAttributes[SemanticAttributes.netPeerName.rawValue], "github.com")
        XCTAssertEqual(networkSpan.stringAttributes[SemanticAttributes.httpUrl.rawValue], "https://github.com/DataDog/dd-sdk-swift-testing")
        ...
        XCTAssertEqual(networkSpan.stringAttributes[SemanticAttributes.httpTarget.rawValue], "/DataDog/dd-sdk-swift-testing")
