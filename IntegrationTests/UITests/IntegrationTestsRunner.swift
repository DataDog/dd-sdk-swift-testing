...
class IntegrationTestsRunner: XCTestCase {
    ...
    func testNetworkIntegration() throws {
        ...
        XCTAssertEqual(networkSpan.stringAttributes[SemanticAttributes.netPeerName.rawValue], "httpbin.io")
        XCTAssertEqual(networkSpan.stringAttributes[SemanticAttributes.httpUrl.rawValue], "https://httpbin.io/get")
