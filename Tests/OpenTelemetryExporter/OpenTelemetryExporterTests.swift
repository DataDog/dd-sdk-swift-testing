...
class OpenTelemetryExporterTests: XCTestCase {
    override func setUp() {
        super.setUp()
    }
    ...
    func testWhenExportSpanIsCalled_thenTraceAndLogsAreUploaded() throws {
        ...
        let exporterConfiguration = ExporterConfiguration(runtimeName: "runtimeName",
        ...
        let datadogExporter = try! OpenTelemetryExporter(config: exporterConfiguration)
